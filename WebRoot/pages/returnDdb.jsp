  ...
  <head>
   ...
   <!-- BEGIN SECTION --> 
            ...
            <section class="wrapper site-min-height">
               <section class="panel">
                  <header class="panel-heading">
                     <span class="label label-primary ">嘀嘀币提现</span>
                        ...
                        <table class="table table-striped table-hover table-bordered" id="sample" >
                           ...
                           <tbody id="payShareContent">
                              <tr class="">
                                 ...
                                 <td class="center hidden-phone">2017-2-1</td>
                                 <td class="center hidden-phone">00207a02ec0c47389780203651a291fc</td>
                                 <td class="center hidden-phone">
                                  <a class="edit" href="javascript:;"><span class="label label-success">同意</span></a>
                                 <a class="edit" href="javascript:;"><span class="label label-success">拒绝</span></a>
                                 <a class="edit" href="javascript:;"><span class="label label-success">查看详情</span></a>
                                 </td> 
                              </tr>
                              ...
                              <tr class="">
                                 ...
                                 <td class="center hidden-phone">2017-11-1</td>
                                 <td class="center hidden-phone">00207a02ec0c47389780203651a291fc</td>
      ...
      <!-- BEGIN JS --> 	  
        ...
        <script src="myjs/returnDdb.js"></script>
